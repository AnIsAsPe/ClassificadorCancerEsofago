...
Las imágenes originales fueron escaladas de 519x521 pixeles a 260x260 para reducir el tiempo y la memoria requeridos para el procesamiento. El conjunto de imágenes utilizadas están disponibles en el archivo comprimido [imagenes_260x260.zip](https://drive.google.com/file/d/1PMHgBsSq1dOdh8dpqZidrmz66BqXrsDG/view?usp=sharing), fuera de este repositorio.
